...
|----------|---------|-------------------------------|
| [AI and ML Systems](../docs/addenda/ai-ml.md) | no | n/a (no ML model, no AI inference) |
| [Web Applications](../docs/addenda/web-applications.md) | no | n/a (CLI-only change; no browser surface) |
| [Event-Driven Systems](../docs/addenda/event-driven.md) | no | n/a (no broker, queue, or stream) |
| [Multi-Service Architectures](../docs/addenda/multi-service.md) | no | n/a (single-repo build-time script change) |
| [Multi-Team Organizations](../docs/addenda/multi-team.md) | no | n/a (single-owner repo) |
| [Containerized Systems](../docs/addenda/containerized-systems.md) | no | n/a (no container or orchestration) |
| [Continuous Improvement](../docs/addenda/continuous-improvement.md) | no | n/a (no formal Lean/Six Sigma session driving this work) |
