...
|----------|---------|-------------------------------|
| [AI and ML Systems](../docs/addenda/ai-ml.md) | no | n/a |
| [Web Applications](../docs/addenda/web-applications.md) | no | n/a |
| [Event-Driven Systems](../docs/addenda/event-driven.md) | no | n/a |
| [Multi-Service Architectures](../docs/addenda/multi-service.md) | no | n/a |
| [Multi-Team Organizations](../docs/addenda/multi-team.md) | no | n/a |
| [Containerized Systems](../docs/addenda/containerized-systems.md) | no | n/a |
| [Continuous Improvement](../docs/addenda/continuous-improvement.md) | no | The investigation is itself a kaizen-style waste audit but does not invoke addendum requirements; no measured-baseline claim is being made. |
