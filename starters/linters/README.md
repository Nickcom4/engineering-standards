...
All eight drift-detection linters from ESE's internal `scripts/` directory are now available here in parameterized form. You do not need to vendor all eight; adopt individually as your project produces the artifact types each one covers.
